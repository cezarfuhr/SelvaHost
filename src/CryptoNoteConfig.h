...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 124; // addresses start with "M"
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 15;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

//300 million coins (Max Supply)
const uint64_t MONEY_SUPPLY                                  = UINT64_C(30000000000000000);
const unsigned EMISSION_SPEED_FACTOR                         = 22;
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(9000000000000000);
...
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_NUMERATOR         = 500000;
...
const size_t   FUSION_TX_MAX_SIZE                            = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT * 50 / 100;
...
const uint32_t UPGRADE_HEIGHT_V2                             = 500000000;
...
const char     CRYPTONOTE_NAME[]                             = "MarketCash";
...
const int      P2P_DEFAULT_PORT                              = 32366;
const int      RPC_DEFAULT_PORT                              = 32367;
...
const char     P2P_STAT_TRUSTED_PUB_KEY[] = "hucruv6c3jev6cecesa6waqakuzestacfee9c918ce505efe225d8c94d045fa115";

const char* const SEED_NODES[] = {
	"18.231.111.16:32366",
	"147.135.21.164:32366",
	"147.135.21.165:32366"
};
